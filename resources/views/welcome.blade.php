...
<body
    ...
    <div
        ...
        <div class="hero-section">
            <h1 class="fade-in">Bienvenido a <span class="highlight">Koonol.mx</span></h1>
            <p id="description" class="description slide-in">
                Somos una comercializadora, distribuidora e importadora, la cual suministra: ingredientes, materias
                primas y aditivos funcionales para la industria alimenticia desde hace más de 12 años. Contamos con
                asesoría técnica para dar solución a las problemáticas que se le presente a nuestro cliente en la
                elaboración de su producto.
            </p>
            <button id="cta-button" class="cta-button pulse">¡Conoce más!</button>
        </div>
...
<script>
    ...
    document.getElementById("cta-button").addEventListener("click", () => {
        alert("¡Gracias por tu interés en Koonol.mx! Pronto te contactaremos.");
    });
</script>
